...
float escala, traslado, rotx;

int main(){
    char *archivo = "../models/horse.ply";
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        // render the cube
        cubo.display(lightingShader);

        curva.display(lightingShader);

        sup.display(lightingShader);
//        esfera.display(lightingShader);
//        modelo1.display(lightingShader);
//        modelo2.traslacion = rotacion_piramide/100.0;
